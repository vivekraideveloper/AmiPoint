 ...
 */
public class QuestionsHome extends RecyclerView.Adapter<QuestionsHome.ImageViewHolder> {

    private Context context;
    private List<Upload> list;
    private QuestionsHome.OnItemClickListener mListener;

    public QuestionsHome(Context context, List<Upload> list){
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.layout_questions_items, parent, false);
        return new QuestionsHome.ImageViewHolder(view);
    }
