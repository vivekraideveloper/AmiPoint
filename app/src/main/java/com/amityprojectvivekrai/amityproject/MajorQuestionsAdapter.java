...
public class MajorQuestionsAdapter extends RecyclerView.Adapter<MajorQuestionsAdapter.ImageViewHolder> {

    private Context context;
    private List<Upload> list;
    private MajorQuestionsAdapter.OnItemClickListener mListener;

    public MajorQuestionsAdapter(Context context, List<Upload> list){
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.major_question_items, parent, false);
        return new MajorQuestionsAdapter.ImageViewHolder(view);
    }
