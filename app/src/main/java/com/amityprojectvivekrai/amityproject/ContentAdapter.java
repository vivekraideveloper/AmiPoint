...
public class ContentAdapter extends RecyclerView.Adapter<ContentAdapter.ImageViewHolder> {
    ...
    public ContentAdapter(Context context, List<Upload> list) {
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ContentAdapter.ImageViewHolder(view);
    }
