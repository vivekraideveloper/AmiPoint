 ...
 */
public class CourseHome extends RecyclerView.Adapter<CourseHome.ImageViewHolder> {

    private Context context;
    private List<Upload> list;
    private CourseHome.OnItemClickListener mListener;

    public CourseHome(Context context, List<Upload> list){
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.layout_course_items, parent, false);
        return new CourseHome.ImageViewHolder(view);
    }
